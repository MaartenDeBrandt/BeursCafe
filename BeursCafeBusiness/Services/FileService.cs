        ...
        public ObservableCollection<Drink> LoadDrinks()
        {
            ...
            else
            {
                return new ObservableCollection<Drink>
                {
                    ...
                    new Drink { Name = "Kwak Blond", DrinksType = DrinkTypes.bier, MinimumPrice = 1, MaximumPrice = 10.0 , DefaultPrice = 3},
                    new Drink { Name = "Kwak Amber", DrinksType = DrinkTypes.bier, MinimumPrice = 1, MaximumPrice = 10.0 , DefaultPrice = 3},
                    new Drink { Name = "Cornet", DrinksType = DrinkTypes.bier, MinimumPrice = 2.0, MaximumPrice = 10.0 , DefaultPrice = 3},
                    new Drink { Name = "Vedett", DrinksType = DrinkTypes.bier, MinimumPrice = 1.5, MaximumPrice = 8.0 , DefaultPrice = 2},

                    new Drink { Name = "St Bernardus abt 12 75cl", DrinksType = DrinkTypes.grotefles, MinimumPrice = 8.0, MaximumPrice = 15.0 , DefaultPrice = 10},                    
                    new Drink { Name = "Aymom 75cl", DrinksType = DrinkTypes.grotefles, MinimumPrice = 6.0, MaximumPrice = 12 , DefaultPrice = 9},
                    new Drink { Name = "Bons vieux 75cl", DrinksType = DrinkTypes.grotefles, MinimumPrice = 4.0, MaximumPrice = 10 , DefaultPrice = 8},
                    new Drink { Name = "Orvelo 75cl", DrinksType = DrinkTypes.grotefles, MinimumPrice = 4.0, MaximumPrice = 10 , DefaultPrice = 8},
        ...
        public List<BreakingNewsModel> LoadBreakingNews(IEnumerable<Drink> allDrinks)
        {
            ...
            else
            {
                breakingNews = new List<BreakingNewsModel>
                {
                    ...
                    new BreakingNewsModel { DrinkNames = "Karmeliet", PriceUpdate = 2, BreakingNews ="Breaking news: Prijsverhoging voor Karmeliet-bier verwacht vanwege beperkte beschikbaarheid en exclusiviteit."},
                    ...
                    new BreakingNewsModel { DrinkNames = "Cristal", PriceUpdate = 1.2, BreakingNews ="Breaking news: Cristal ziet prijsstijging door de toenemende vraag naar deze verfrissende en iconische Belgische dorstlesser."},                    
                    new BreakingNewsModel { DrinkNames = "Geuze Boon", PriceUpdate = 2.1, BreakingNews ="Breaking news: Geuze Boon prijzen verwacht te stijgen vanwege groeiende internationale populariteit van deze traditionele Belgische geuze."},
                    ...
                    new BreakingNewsModel { DrinkNames = "Stella Artois", PriceUpdate = 1.1, BreakingNews ="Breaking news: Tijdelijke prijsverhoging voor Stella Artois vanwege de groeiende wereldwijde populariteit van dit iconische Belgische bier."},
                    new BreakingNewsModel { DrinkNames = "Chimay Blauw", PriceUpdate = 1.6, BreakingNews ="Breaking news: Chimay Blauw ervaart tijdelijke prijsstijging vanwege de beperkte beschikbaarheid en de prestigieuze reputatie van dit trappistenbier."},


                    new BreakingNewsModel { DrinkNames = "Kriek Lindemans", PriceUpdate = -2, BreakingNews ="Promotie: Kriek Lindemans binnenkort in prijs verlaagd - Geniet van de fruitige frisheid van deze kriek tegen een voordelige prijs!"},
                    new BreakingNewsModel { DrinkNames = "Chimay Groen", PriceUpdate = -2, BreakingNews ="Promotie: Chimay Groen binnenkort goedkoper - Profiteer van de gelegenheid om dit karaktervolle trappistenbier te proeven voor een scherpe prijs!"},
                    new BreakingNewsModel { DrinkNames = "Duvel", PriceUpdate = -2, BreakingNews ="Promotie: Duvel binnenkort in de aanbieding - Profiteer binnenkort van tijdelijk lagere prijzen voor dit heerlijke Belgische bier!"},
                    new BreakingNewsModel { DrinkNames = "Kwak Blond,Kwak Amber,Kwak amber 75cl", PriceUpdate = -3, BreakingNews ="Promotie: Brouwerij Bosteels verrast bierliefhebbers met spannende promotie op Kwak bieren."},
                    ...
                    new BreakingNewsModel { DrinkNames = "St Bernardus abt 12 75cl", PriceUpdate = -2, BreakingNews = "Promotie: Binnenkort prijsverlaging voor St. Bernardus Abt 12 - Geniet van dit kwaliteitsbier voor een voordelige prijs!"},
                    new BreakingNewsModel { DrinkNames = "Aymom 75cl", PriceUpdate = -2, BreakingNews = "Promotie: Aymon binnenkort in de aanbieding - Profiteer van een beperkte periode van lagere prijzen voor dit heerlijke brouwsel!"},
                    new BreakingNewsModel { DrinkNames = "Bons vieux 75cl", PriceUpdate = -2, BreakingNews = "Promotie: Bons Vieux binnenkort goedkoper - Mis deze kans niet om te genieten van dit klassieke bier voor een geweldige prijs!"},
                    new BreakingNewsModel { DrinkNames = "Orvelo 75cl", PriceUpdate = -2, BreakingNews = "Promotie: Orvelo binnenkort in prijs verlaagd - Proef de smaakvolle sensatie zonder de bank te breken!"},
                    new BreakingNewsModel { DrinkNames = "Kwak blond 75cl,Kwak Blond", PriceUpdate = -2, BreakingNews = "Promotie: Kwak Blond binnenkort in de aanbieding - Ontdek dit karaktervolle blond bier voor een scherpe prijs!"},
                    new BreakingNewsModel { DrinkNames = "Kwak amber 75cl,Kwak Amber", PriceUpdate = -2, BreakingNews = "Promotie: Kwak Amber binnenkort goedkoper - Geniet van de rijke smaak van dit amberkleurige bier tegen een gereduceerde prijs!"},
                    new BreakingNewsModel { DrinkNames = "Cava brut 75cl", PriceUpdate = -1, BreakingNews = "Promotie: Binnenkort prijsverlaging voor Cava Brut - Verwen jezelf met deze sprankelende traktatie zonder je budget te belasten!"},
                };
            }
